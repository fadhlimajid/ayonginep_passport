...
class UserRepository implements UserRepositoryInterface
{
     ...
     * {@inheritdoc}
     */
    public function getUserEntityByUserCredentials($email, $password, $grantType, ClientEntityInterface $clientEntity)
    {
    ...
    public function getEntityByUserCredentials($email, $password, $grantType, ClientEntityInterface $clientEntity, $newProvider)
    {
